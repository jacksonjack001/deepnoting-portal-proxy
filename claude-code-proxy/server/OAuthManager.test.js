...
describe('OAuthManager', () => {
  ...
  describe('exchangeCodeForTokens', () => {
    it('should exchange authorization code for tokens', async () => {
      ...
      nock('https://platform.claude.com')
        .post('/v1/oauth/token', body => {
          const params = new URLSearchParams(body);
          return params.get('grant_type') === 'authorization_code'
            && params.get('code') === 'test-auth-code'
            && params.get('state') === 'test-state'
            && params.get('client_id') === '9d1c250a-e61b-44d9-88ed-5944d1962f5e'
            && params.get('code_verifier') === 'test-code-verifier'
            && params.get('redirect_uri') === 'https://platform.claude.com/oauth/code/callback';
        })
